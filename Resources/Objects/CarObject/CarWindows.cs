...
{
    internal class CarWindows : Face
    {
        ...
        private Color4 ColorShape = new(0.19608f, 0.64314f, 0.65882f, 1);



        //constructor
        public CarWindows() : base()
        {
            LoadPartData(_vertexArray, _indexArray, _origin, ColorShape);
        }

        public CarWindows(Vector3 relativePosition) : base()
        {
